...
- **Rule:**
  ...
  - Contrôle : C20, bloquant sur les deux forges **et dans le hook `pre-receive`** (décidé le 16/09/2026, story 1.5) : la CI seule arriverait après la publication par le miroir. L'outil de lecture des métadonnées doit donc être présent là où tourne Gitea, comme `poppler-utils` pour C21. D'ici là (story 5.4), le hook refuse les extensions d'images.
