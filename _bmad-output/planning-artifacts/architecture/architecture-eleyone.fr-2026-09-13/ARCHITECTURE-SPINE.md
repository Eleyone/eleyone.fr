...
| C4 | Rubriques H2 dans la liste de `data/rubrics.yaml`, dans l'ordre (story 3.3, 18/09/2026 : la liste passe du document aux données ; `docs/format-cas.md` y renvoie) | `scripts/checks/content.sh` | oui | oui | FR-8 |
